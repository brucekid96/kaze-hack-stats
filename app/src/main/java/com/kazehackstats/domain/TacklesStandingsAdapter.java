...
public class TacklesStandingsAdapter extends RecyclerView.Adapter<TacklesStandingsAdapter.MyViewHolder> {
  //  private List<Match> mMatches;
  private List<TeamStatLine> mTeamStatLines;
  private List<Match> mMatchs;
  private Context mContext;

  public TacklesStandingsAdapter(List<Match> mMatchs,
      Context mContext) {
  ...
  @NonNull
  @Override
  public TacklesStandingsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.standing_item,parent,false);
    return new TacklesStandingsAdapter.MyViewHolder(v);
  }



  @Override
  public void onBindViewHolder(@NonNull TacklesStandingsAdapter.MyViewHolder holder, int position) {
