...
public class CornersStandingsAdapter extends RecyclerView.Adapter<CornersStandingsAdapter.MyViewHolder> {
  ...
  @NonNull
  @Override
  public CornersStandingsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.standing_item,parent,false);
    return new CornersStandingsAdapter.MyViewHolder(v);
  }



  @Override
  public void onBindViewHolder(@NonNull CornersStandingsAdapter.MyViewHolder holder, int position) {
