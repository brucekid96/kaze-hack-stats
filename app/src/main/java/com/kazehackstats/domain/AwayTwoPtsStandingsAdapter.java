...
public class AwayTwoPtsStandingsAdapter extends RecyclerView.Adapter<AwayTwoPtsStandingsAdapter.MyViewHolder> {
  //  private List<Match> mMatches;
  private List<TeamStatLine> mTeamStatLines;
  private List<BasketballMatch> mBasketballMatchs;
  private Context mContext;

  public AwayTwoPtsStandingsAdapter(List<BasketballMatch> mBasketballMatchs,
      Context mContext) {
  ...
  @NonNull
  @Override
  public AwayTwoPtsStandingsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.standing_item,parent,false);
    return new AwayTwoPtsStandingsAdapter.MyViewHolder(v);
  }



  @Override
  public void onBindViewHolder(@NonNull AwayTwoPtsStandingsAdapter.MyViewHolder holder, int position) {
