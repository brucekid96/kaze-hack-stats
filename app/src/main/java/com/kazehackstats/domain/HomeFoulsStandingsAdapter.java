...
public class HomeFoulsStandingsAdapter extends RecyclerView.Adapter<HomeFoulsStandingsAdapter.MyViewHolder> {
  //  private List<Match> mMatches;
  private List<TeamStatLine> mTeamStatLines;
  private List<Match> mMatchs;
  private Context mContext;

  public HomeFoulsStandingsAdapter(List<Match> mMatchs,
      Context mContext) {
  ...
  @NonNull
  @Override
  public HomeFoulsStandingsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.standing_item,parent,false);
    return new HomeFoulsStandingsAdapter.MyViewHolder(v);
  }



  @Override
  public void onBindViewHolder(@NonNull HomeFoulsStandingsAdapter.MyViewHolder holder, int position) {
