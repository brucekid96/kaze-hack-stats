...
public class SavesStandingsAdapter extends RecyclerView.Adapter<SavesStandingsAdapter.MyViewHolder> {
  //  private List<Match> mMatches;
  private List<TeamStatLine> mTeamStatLines;
  private List<Match> mMatchs;
  private Context mContext;

  public SavesStandingsAdapter(List<Match> mMatchs,
      Context mContext) {
  ...
  @NonNull
  @Override
  public SavesStandingsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.standing_item,parent,false);
    return new SavesStandingsAdapter.MyViewHolder(v);
  }



  @Override
  public void onBindViewHolder(@NonNull SavesStandingsAdapter.MyViewHolder holder, int position) {
