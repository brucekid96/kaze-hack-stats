...
public class AwayReboundsStandingsAdapter extends RecyclerView.Adapter<AwayReboundsStandingsAdapter.MyViewHolder> {
  //  private List<Match> mMatches;
  private List<TeamStatLine> mTeamStatLines;
  private List<BasketballMatch> mBasketballMatchs;
  private Context mContext;

  public AwayReboundsStandingsAdapter(List<BasketballMatch> mBasketballMatchs,
      Context mContext) {
  ...
  @NonNull
  @Override
  public AwayReboundsStandingsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.standing_item,parent,false);
    return new AwayReboundsStandingsAdapter.MyViewHolder(v);
  }



  @Override
  public void onBindViewHolder(@NonNull AwayReboundsStandingsAdapter.MyViewHolder holder, int position) {
