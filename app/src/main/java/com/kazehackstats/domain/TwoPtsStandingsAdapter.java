...
public class TwoPtsStandingsAdapter extends RecyclerView.Adapter<TwoPtsStandingsAdapter.MyViewHolder> {
  //  private List<Match> mMatches;
  private List<TeamStatLine> mTeamStatLines;
  private List<BasketballMatch> mBasketballMatchs;
  private Context mContext;

  public TwoPtsStandingsAdapter(List<BasketballMatch> mBasketballMatchs,
      Context mContext) {
  ...
  @NonNull
  @Override
  public TwoPtsStandingsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.standing_item,parent,false);
    return new TwoPtsStandingsAdapter.MyViewHolder(v);
  }



  @Override
  public void onBindViewHolder(@NonNull TwoPtsStandingsAdapter.MyViewHolder holder, int position) {
