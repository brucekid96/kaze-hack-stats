...
public class Championship extends AppCompatActivity {
  private static final String DBG_TAG = Championship.class.getSimpleName();
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    a.putExtra("league","Championship");
    ...
    b.putExtra("league","Championship");
    ...
    c.putExtra("league","Championship");
    ...
    d.putExtra("league","Championship");
    ...
    e.putExtra("league","Championship");
    ...
    f.putExtra("league","Championship");
    ...
    g.putExtra("league","Championship");
    ...
    h.putExtra("league","Championship");
    ...
    i.putExtra("league","Championship");
    ...
    j.putExtra("league","Championship");
    ...
    k.putExtra("league","Championship");
    ...
    l.putExtra("league","Championship");
    ...
    m.putExtra("league","Championship");
    ...
    n.putExtra("league","Championship");
    ...
    o.putExtra("league","Championship");
    ...
    p.putExtra("league","Championship");
    ...
    q.putExtra("league","Championship");
    ...
    r.putExtra("league","Championship");
    ...
    s.putExtra("league","Championship");
    ...
    t.putExtra("league","Championship");
    ...
    u.putExtra("league","Championship");
