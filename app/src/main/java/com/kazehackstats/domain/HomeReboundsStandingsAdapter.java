...
public class HomeReboundsStandingsAdapter extends RecyclerView.Adapter<HomeReboundsStandingsAdapter.MyViewHolder> {
  //  private List<Match> mMatches;
  private List<TeamStatLine> mTeamStatLines;
  private List<BasketballMatch> mBasketballMatchs;
  private Context mContext;

  public HomeReboundsStandingsAdapter(List<BasketballMatch> mBasketballMatchs,
      Context mContext) {
  ...
  @NonNull
  @Override
  public HomeReboundsStandingsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.standing_item,parent,false);
    return new HomeReboundsStandingsAdapter.MyViewHolder(v);
  }



  @Override
  public void onBindViewHolder(@NonNull HomeReboundsStandingsAdapter.MyViewHolder holder, int position) {
