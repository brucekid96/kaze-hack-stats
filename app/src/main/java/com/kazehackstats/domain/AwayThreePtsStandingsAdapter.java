...
public class AwayThreePtsStandingsAdapter extends RecyclerView.Adapter<AwayThreePtsStandingsAdapter.MyViewHolder> {
  ...
  @NonNull
  @Override
  public AwayThreePtsStandingsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.standing_item,parent,false);
    return new AwayThreePtsStandingsAdapter.MyViewHolder(v);
  }



  @Override
  public void onBindViewHolder(@NonNull AwayThreePtsStandingsAdapter.MyViewHolder holder, int position) {
