...
public class ReboundsStandingsAdapter extends RecyclerView.Adapter<ReboundsStandingsAdapter.MyViewHolder> {
  //  private List<Match> mMatches;
  private List<TeamStatLine> mTeamStatLines;
  private List<BasketballMatch> mBasketballMatchs;
  private Context mContext;

  public ReboundsStandingsAdapter(List<BasketballMatch> mBasketballMatchs,
      Context mContext) {
  ...
  @NonNull
  @Override
  public ReboundsStandingsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.standing_item,parent,false);
    return new ReboundsStandingsAdapter.MyViewHolder(v);
  }



  @Override
  public void onBindViewHolder(@NonNull ReboundsStandingsAdapter.MyViewHolder holder, int position) {
